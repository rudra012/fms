...
class VehiclCreateUpdateSerializer():
    ...
    class Meta:
        fields = [
            'id', 'vehicle_name', 'vin_no', 'vehicle_make', 'vehicle_model', 'vehicle_year',
            'vehicle_license', 'registration_state', 'vehiclestatus_id', 'group_id', 'contact_id', 'ownership',
            'company_id',
        ]


class VehiclReadSerializer(serializers.ModelSerializer):
    class Meta:
        model = Vehicle
        fields = [
            'id', 'vehicle_name', 'vin_no', 'vehicle_make', 'vehicle_model', 'vehicle_year',
