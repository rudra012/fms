...
class Vehicle(TimeStampedModel,BaseModel):
    ...
    vehiclestatus_id = models.CharField(max_length=255, blank=True, null=True)
...
class VehicleDocument(TimeStampedModel,BaseModel):
    id = models.AutoField(primary_key=True, db_index=True)
